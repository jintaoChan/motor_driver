...
#define PID_TORQUE_KP_DEFAULT               3674
#define PID_TORQUE_KI_DEFAULT               3739
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 3674
#define PID_FLUX_KI_DEFAULT                 3739
...
#define PID_SPEED_KP_DEFAULT                3388/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                607/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define OV_VOLTAGE_THRESHOLD_V              43.2 /*!< Over-voltage threshold */
