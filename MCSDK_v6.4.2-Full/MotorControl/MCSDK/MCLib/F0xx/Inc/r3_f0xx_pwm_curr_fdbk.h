...
typedef struct
{
  ...
  uint8_t b_ISamplingTime;                  /*!< Sampling time used to convert hI[a|b|c]Channel.
                                             *   Must be equal to ADC_SampleTime_xCycles5 ; x= 1, 7, ... Specific to F0XX. */
...
typedef struct
{
  ...
  volatile uint16_t ADC1_DMA_converted[2];  /*!< Buffer used for DMA data transfer after the ADC conversion. Specific to F0XX, G0XX and C0XX. */
...
/*
  ...
  * reading configuration using STM32F0xx.
  */
