/**
  ******************************************************************************
  * @file    r3_1_h5xx_pwm_curr_fdbk.c
  ...
  *
  ******************************************************************************
  * @ingroup R3_1_H5XX_pwm_curr_fdbk
  */
...
static void R3_1_RLGetPhaseCurrents( PWMC_Handle_t * pHdl, ab_t * Iab );
...
__weak void R3_1_Init( PWMC_R3_1_Handle_t * pHandle )
{
  ...
  ADC_TypeDef * ADCx = pHandle->pParams_str->ADCx;
    ...
    /*Checks that _Super is the first member of the structure PWMC_R3_1_Handle_t */
