...
/*
  ...
  * reading configuration using STM32L4x.
  */
...
/*
  * Configures the ADC for the currents sampling related to sector X (X = [1..6] ) in case of overmodulation.
  */
...
/*
 * Turns on low side switches and start ADC triggering.
 */
