...
<#-- <#function _first_word text sep="-"><#return text?split(sep)?first></#function> -->
  ...
  <#if NucleoCond == true >
      ...
      <#assign BoardEnable2_Port  = "GPIOC">
      <#assign BoardEnable2_Pin  = "5">
  ...
  <#elseif NucleoCondG4 == true>
      ...
      <#assign CS_Port = "GPIOC">
      <#assign CS_Pin  = "6">
  <#elseif NucleoCondG0 == true>
      <#assign BoardEnable_Port  = "GPIOB">
      <#assign BoardEnable_Pin  = "6">
      <#assign BoardEnable2_Port  = "GPIOC">
      <#assign BoardEnable2_Pin  = "1">	
      <#assign CS_Port = "GPIOC">
      <#assign CS_Pin  = "6">
  <#elseif NucleoCondC0 == true>
      <#assign BoardEnable_Port  = "GPIOB">
      <#assign BoardEnable_Pin  = "8">
      <#assign BoardEnable2_Port  = "GPIOB">
      <#assign BoardEnable2_Pin  = "0">	
      <#assign CS_Port = "GPIOC">
      <#assign CS_Pin  = "13">
  ...
  <#else>
    ...
    <#assign BoardEnable2_Port = "">
    <#assign BoardEnable2_Pin  = "">
    <#assign FOC_6STEP_Port = "">
    <#assign FOC_6STEP_Pin  = "">
  </#if>
  /**
  ******************************************************************************
...
static inline void mc_testenv_init ()
#ifdef MC_HAL_IS_USED
  {
    ...
    /* Enabling clock for Board Enable 2 control GPIO Port */
    if (__HAL_RCC_${BoardEnable2_Port}_IS_CLK_DISABLED())
    {
      __HAL_RCC_${BoardEnable2_Port}_CLK_ENABLE();
    }

    /* Enabling clock for drive control GPIO Port */
    if (__HAL_RCC_${FOC_6STEP_Port}_IS_CLK_DISABLED())
    {
      __HAL_RCC_${FOC_6STEP_Port}_CLK_ENABLE();
    }

    /* Enabling clock current sensing GPIO Port */
    ...
    HAL_GPIO_WritePin( ${BoardEnable2_Port}, GPIO_PIN_${BoardEnable2_Pin}, GPIO_PIN_SET );

    /*  6STEP Enable */
    HAL_GPIO_WritePin( ${FOC_6STEP_Port}, GPIO_PIN_${FOC_6STEP_Pin}, GPIO_PIN_SET );
    ...
    /* Configuring the Test Board Enable 2 GPIO port and pin */  
    GPIO_InitStruct.Pin = GPIO_PIN_${BoardEnable2_Pin};
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init( ${BoardEnable2_Port}, &GPIO_InitStruct );



    /* Configuring the control type GPIO port and pin */  
    GPIO_InitStruct.Pin = GPIO_PIN_${FOC_6STEP_Pin};
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init( ${FOC_6STEP_Port}, &GPIO_InitStruct );
...
#else /* MC_HAL_IS_USED */
  {
    ...
    /* Enabling clock for Board Enable 2 control GPIO Port */
    if (  LL_AHB1_GRP1_IsEnabledClock( LL_AHB1_GRP1_PERIPH_${BoardEnable2_Port} ) ) 
    {
      /* GPIOC block clock is not enabled. Enable it */
      LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_${BoardEnable2_Port});
    }

    /* Enabling clock for drive control GPIO Port */
    if (  LL_AHB1_GRP1_IsEnabledClock( LL_AHB1_GRP1_PERIPH_${FOC_6STEP_Port} ) ) 
    {
      LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_${FOC_6STEP_Port});
    }


    /*  Test Board Enable */
    LL_GPIO_SetOutputPin( ${BoardEnable_Port}, LL_GPIO_PIN_${BoardEnable_Pin} );   
    LL_GPIO_SetOutputPin( ${BoardEnable2_Port}, LL_GPIO_PIN_${BoardEnable2_Pin} ); 

    /*  6STEP Enable */
    LL_GPIO_SetOutputPin( ${FOC_6STEP_Port}, LL_GPIO_PIN_${FOC_6STEP_Pin} ); 

    /*  current sensing set to 1 shunt */
    LL_GPIO_SetOutputPin( ${CS_Port}, LL_GPIO_PIN_${CS_Pin} ); 
    
 
    /* Configuring Board Enable GPIO port and pin */  
    ...
    /* Configuring Board Enable 2 GPIO port and pin */  
    GPIO_TestEnvInitStruct.Pin = LL_GPIO_PIN_${BoardEnable2_Pin};
    GPIO_TestEnvInitStruct.Mode = LL_GPIO_MODE_OUTPUT;
    GPIO_TestEnvInitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
    GPIO_TestEnvInitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
    GPIO_TestEnvInitStruct.Pull = LL_GPIO_PULL_NO;
    LL_GPIO_Init( ${BoardEnable2_Port}, &GPIO_TestEnvInitStruct );

    /* Configuring control Type GPIO port and pin */  
    GPIO_TestEnvInitStruct.Pin = LL_GPIO_PIN_${FOC_6STEP_Pin};
    GPIO_TestEnvInitStruct.Mode = LL_GPIO_MODE_OUTPUT;
    GPIO_TestEnvInitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
    GPIO_TestEnvInitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
    GPIO_TestEnvInitStruct.Pull = LL_GPIO_PULL_NO;
    LL_GPIO_Init( ${FOC_6STEP_Port}, &GPIO_TestEnvInitStruct );
 ...
 static inline void mc_testenv_clear ()
#ifdef MC_HAL_IS_USED
  {
    ...
    /*  Test Board Enable 2 */
    HAL_GPIO_WritePin( ${BoardEnable2_Port}, GPIO_PIN_${BoardEnable2_Pin}, GPIO_PIN_RESET );
...
#else /* MC_HAL_IS_USED */
  {
    ...
    LL_GPIO_ResetOutputPin( ${BoardEnable2_Port}, LL_GPIO_PIN_${BoardEnable2_Pin} );   
