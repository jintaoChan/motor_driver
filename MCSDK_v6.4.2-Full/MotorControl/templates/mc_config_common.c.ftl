...
<#if (MC.M1_SPEED_SENSOR == "STO_PLL") || (MC.M1_SPEED_SENSOR == "STO_CORDIC") || M1_ENCODER || (MC.M1_DBG_OPEN_LOOP_ENABLE && MC.M1_DRIVE_TYPE != "SIX_STEP")>
/**
...
<#-------------------------------------------------------------------------------------->
  <#if (MC.M2_SPEED_SENSOR == "STO_PLL") || (MC.M2_SPEED_SENSOR == "STO_CORDIC") || M2_ENCODER || (MC.M2_DBG_OPEN_LOOP_ENABLE && MC.M2_DRIVE_TYPE != "SIX_STEP")>
/**
...
RegConv_t VbusRegConv_M2 =
{
  ...
  .data                     = 1 + (uint16_t)((NOMINAL_BUS_VOLTAGE_V2 * 65536) / (ADC_REFERENCE_VOLTAGE / VBUS_PARTITIONING_FACTOR2))
};
...
${MC.M1_PWM_DRIVER_PN?upper_case}_Handle_t ${MC.M1_PWM_DRIVER_PN?upper_case}_Handle_M1;
</#if>
<#if MC.DRIVE_NUMBER != "1">
  <#if MC.M2_COMPLEX_GATE_DRIVER_INTERFACE != "NONE">
${MC.M2_PWM_DRIVER_PN?upper_case}_Handle_t ${MC.M2_PWM_DRIVER_PN?upper_case}_Handle_M2;
  </#if>
</#if>
