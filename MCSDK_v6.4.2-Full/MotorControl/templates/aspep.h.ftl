...
<#if !MCP_DMA>
typedef bool (*ASPEP_trigger_transmission_cb_t)   (void *pASPEP_Handle);
typedef bool (*ASPEP_trigger_reception_cb_t)      (void *pASPEP_Handle);
</#if><#-- !MCP_DMA -->
...
<#if !MCP_DMA>
  ASPEP_trigger_reception_cb_t fASPEP_trig_recept;        /*!< Pointer to the receiving packet function */
  ASPEP_trigger_transmission_cb_t fASPEP_trig_trans;      /*!< Pointer to the sending packet function */
  bool rxComplete;                                        /*!< Flag to check if data has been received entirely before processing data */
  bool txComplete;                                        /*!< Flag to check if data has been transmitted entirely before freeing buffer */
 </#if><#-- MCP_DMA -->
