...
#define MIN_APPLICATION_SPEED_RPM           ${MC.M1_MIN_APPLICATION_SPEED} /*!< rpm, mechanical, absolute value */
...
#define STO_FIFO_DEPTH_DPP                  ${MC.M1_STO_FIFO_DEPTH_DPP} /*!< Depth of the FIFO used  to average mechanical speed in dpp format */
#define STO_FIFO_DEPTH_DPP_LOG              LOG2((${MC.M1_STO_FIFO_DEPTH_DPP}))
#define STO_FIFO_DEPTH_UNIT                 ${MC.M1_STO_FIFO_DEPTH_01HZ} /*!< Depth of the FIFO used to average mechanical speed in the unit defined by #SPEED_UNIT */
#define M1_BEMF_CONSISTENCY_TOL             ${MC.M1_BEMF_CONSISTENCY_TOL} /* Parameter for B-emf amplitude-speed consistency */
#define M1_BEMF_CONSISTENCY_GAIN            ${MC.M1_BEMF_CONSISTENCY_GAIN} /* Parameter for B-emf amplitude-speed consistency */
</#if>

<#if (MC.M1_SPEED_SENSOR == "STO_CORDIC") || (MC.M1_AUXILIARY_SPEED_SENSOR == "STO_CORDIC") >
/****** State Observer + CORDIC ***/
#define CORD_VARIANCE_THRESHOLD             ${MC.M1_CORD_VARIANCE_THRESHOLD} /*!< Maxiumum accepted variance on speed estimates (percentage) */
...
#define CORD_FIFO_DEPTH_DPP                 ${MC.M1_CORD_FIFO_DEPTH_DPP} /*!< Depth of the FIFO used to average  mechanical speed in dpp format */
#define CORD_FIFO_DEPTH_DPP_LOG             LOG2((${MC.M1_CORD_FIFO_DEPTH_DPP}))
#define CORD_FIFO_DEPTH_UNIT                ${MC.M1_CORD_FIFO_DEPTH_01HZ} /*!< Depth of the FIFO used to average mechanical speed in dpp format */
#define CORD_MAX_ACCEL_DPPP                 ${MC.M1_CORD_MAX_ACCEL_DPPP} /*!< Maximum instantaneous electrical acceleration (dpp per control period) */
#define M1_CORD_BEMF_CONSISTENCY_TOL        ${MC.M1_CORD_BEMF_CONSISTENCY_TOL} /* Parameter for B-emf amplitude-speed consistency */
#define M1_CORD_BEMF_CONSISTENCY_GAIN       ${MC.M1_CORD_BEMF_CONSISTENCY_GAIN} /* Parameter for B-emf amplitude-speed consistency */
</#if>

<#if MC.M1_SPEED_SENSOR == "HSO" || MC.M1_SPEED_SENSOR == "ZEST">
#define CURRENT_RECONSTRUCTION_THRESHOLD    0.8660254 /*!< @brief Duty cycle above which low a side current shunt sample
                                                           is disqualified and needs to be reconstructed. 
...
#define FREQUENCY_SCALE                     (float_t)(1000.0f) /*!< @brief Frequency calculation scale. forced to 1000Hz when profiler is 
                                                                           used */
<#else>
...
#define KSAMPLE_DELAY                       ${MC.M1_KSAMPLE_DELAY} /*!< @brief Compensation factor to mitigate the difference between voltage sampling instant and current sampling instant */
...
#define PULSE_CURRENT_GOAL                  (${MC.M1_POLPULSES_PULSE_CURRENT_GOAL}) /*!< @brief pulse current goal. */

#define RSDC_TOTAL_MEASURE_TIME_MS  1000    /* milli-seconds */
#define RSDC_SLOP_MS                 250    /* milli-seconds */
#define RSDC_TOTAL_MEASURE_TIME_TICKS (uint32_t) (RSDC_TOTAL_MEASURE_TIME_MS * SPEED_LOOP_FREQUENCY_HZ /1000)
#define RSDC_SLOP_TICKS               (uint32_t) (RSDC_SLOP_MS * SPEED_LOOP_FREQUENCY_HZ /1000)

/* config for fast RsDC */
#define FAST_RSDC_TOTAL_MEASURE_TIME_MS  10    /* milli-seconds */
#define FAST_RSDC_SLOP_MS                 1    /* milli-seconds */
#define FAST_RSDC_TOTAL_MEASURE_TIME_TICKS (uint32_t) (FAST_RSDC_TOTAL_MEASURE_TIME_MS * SPEED_LOOP_FREQUENCY_HZ /1000)
#define FAST_RSDC_SLOP_TICKS               (uint32_t) (FAST_RSDC_SLOP_MS * SPEED_LOOP_FREQUENCY_HZ /1000)
</#if>
...
#define REGULATION_EXECUTION_RATE           ${MC.M1_REGULATION_EXECUTION_RATE} /*!< FOC execution rate in number of PWM cycles */
...
#define NB_CONSECUTIVE_TESTS                ${MC.M1_NB_CONSECUTIVE_TESTS} /* corresponding to former 
...
#define FW_VOLTAGE_REF                      ${MC.M1_FW_VOLTAGE_REF} /*!<Vs reference, tenth of a percent */
#define FW_KP_GAIN                          ${MC.M1_FW_KP_GAIN} /*!< Default Kp gain */
#define FW_KI_GAIN                          ${MC.M1_FW_KI_GAIN} /*!< Default Ki gain */
#define FW_KPDIV                            ${MC.M1_FW_KPDIV} /*!< Kp gain divisor.If FULL_MISRA_C_COMPLIANCY is not defined the divisor is implemented through algebrical
...
#define FW_KIDIV                            ${MC.M1_FW_KIDIV} /*!< Ki gain divisor.If FULL_MISRA_C_COMPLIANCY is not defined the divisor is implemented through algebrical
                                                 right shifts to speed up PIs execution. Only in this case this parameter specifies the number of right
                                                 shifts to be executed */
...
/****** State Observer + PLL ****/
#define VARIANCE_THRESHOLD2                 ${MC.M2_VARIANCE_THRESHOLD} /*!< Maximum accepted variance on speed estimates (percentage) */
...
#define STO_FIFO_DEPTH_DPP2                 ${MC.M2_STO_FIFO_DEPTH_DPP} /*!< Depth of the FIFO used to average mechanical speed in dpp format */
#define STO_FIFO_DEPTH_DPP_LOG2             LOG2((${MC.M2_STO_FIFO_DEPTH_DPP}))
#define STO_FIFO_DEPTH_UNIT2                ${MC.M2_STO_FIFO_DEPTH_01HZ} /*!< Depth of the FIFO used to average mechanical speed in dpp format */
#define M2_BEMF_CONSISTENCY_TOL             ${MC.M2_BEMF_CONSISTENCY_TOL} /* Parameter for B-emf amplitude-speed consistency */
#define M2_BEMF_CONSISTENCY_GAIN            ${MC.M2_BEMF_CONSISTENCY_GAIN} /* Parameter for B-emf amplitude-speed mconsistency */
</#if>

<#if (MC.M2_SPEED_SENSOR == "STO_CORDIC") || (MC.M2_AUXILIARY_SPEED_SENSOR == "STO_CORDIC") >
/****** State Observer + CORDIC ***/
#define CORD_VARIANCE_THRESHOLD2            ${MC.M2_CORD_VARIANCE_THRESHOLD} /*!< Maxiumum accepted variance on speed estimates (percentage) */
...
#define CORD_FIFO_DEPTH_DPP2                ${MC.M2_CORD_FIFO_DEPTH_DPP} /*!< Depth of the FIFO used to average mechanical speed in dpp format */
#define CORD_FIFO_DEPTH_DPP_LOG2            LOG2((${MC.M2_CORD_FIFO_DEPTH_DPP}))
#define CORD_FIFO_DEPTH_UNIT2               ${MC.M2_CORD_FIFO_DEPTH_01HZ} /*!< Depth of the FIFO used to average mechanical speed in dpp format */
#define CORD_MAX_ACCEL_DPPP2                ${MC.M2_CORD_MAX_ACCEL_DPPP} /*!< Maximum instantaneous electrical acceleration (dpp per control period) */
#define M2_CORD_BEMF_CONSISTENCY_TOL        ${MC.M2_CORD_BEMF_CONSISTENCY_TOL} /* Parameter for B-emf amplitude-speed consistency */
#define M2_CORD_BEMF_CONSISTENCY_GAIN       ${MC.M2_CORD_BEMF_CONSISTENCY_GAIN} /* Parameter for B-emf amplitude-speed consistency */
</#if>
...
#define FREQ_RELATION                       ${M1_FREQ_RELATION} /* It refers to motor 1 and can be HIGHEST_FREQ or LOWEST frequency depending on motor 1 and 2 frequency relationship */
#define FREQ_RELATION2                      ${M2_FREQ_RELATION} /* It refers to motor 2 and can be HIGHEST_FREQ or  LOWEST frequency depending on motor 1 and 2 frequency relationship */
...
#define PID_SPEED_INTEGRAL_INIT_DIV2        0 
...
<#if (MC.M2_SPEED_SENSOR == "STO_PLL") || (MC.M2_SPEED_SENSOR == "STO_CORDIC") || (MC.M2_AUXILIARY_SPEED_SENSOR == "STO_PLL") || (MC.M2_AUXILIARY_SPEED_SENSOR == "STO_CORDIC") >
/* Observer start-up output conditions  */
#define OBS_MINIMUM_SPEED_RPM2              ${MC.M2_OBS_MINIMUM_SPEED_RPM}
#define NB_CONSECUTIVE_TESTS2               ${MC.M2_NB_CONSECUTIVE_TESTS} /* corresponding to former  NB_CONSECUTIVE_TESTS / (TF_REGULATION_RATE / MEDIUM_FREQUENCY_TASK_RATE) */
...
#define FW_VOLTAGE_REF2                     ${MC.M2_FW_VOLTAGE_REF} /*!<Vs reference, tenth of a percent */
#define FW_KP_GAIN2                         ${MC.M2_FW_KP_GAIN} /*!< Default Kp gain */
#define FW_KI_GAIN2                         ${MC.M2_FW_KI_GAIN} /*!< Default Ki gain */
#define FW_KPDIV2                           ${MC.M2_FW_KPDIV} /*!< Kp gain divisor.If FULL_MISRA_C_COMPLIANCY is not defined the divisor is implemented through algebrical
                                                 right shifts to speed up PIs execution. Only in this case this parameter specifies the number
                                                 of right shifts to be executed */
#define FW_KIDIV2                           ${MC.M2_FW_KIDIV} /*!< Ki gain divisor.If FULL_MISRA_C_COMPLIANCY is not defined the divisor is implemented through algebrical
                                                 right shifts to speed up PIs execution. Only in this case this parameter specifies the number of right
                                                 shifts to be executed */
