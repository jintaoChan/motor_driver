...
<#-- <#function _first_word text sep="-"><#return text?split(sep)?first></#function> -->
  ...
  <#assign NucleoCond = MC.BOARD?contains("NUCLEO") || 
                        ...
                        McuName?starts_with("STM32C031C6") 
                        >
  ...
  <#-- 3 Pins need to be configured to drive the WELL board 
       CS stands for Current sensing - 3Shunt(low) or 1 Shunt(high)  - Connected to MC connector V1 DissipativeBrake
       SF stands for Speed feedback  - HALL or Encoder sensor - Connected to MC connector V1 ICL or MC_NTC (depending on the board)
       PM stands for Performance Measurement - Connected to Motor connector PFC SYNC
       FOC_6STEP stands for control type - Connected to Motor connector PFC PWM
	   BoardEnable stands for board detection in Automatic test 
    The connection with Morpho connector is done trough CN10-2 and CN10-4 (from IHM07 schematic)
  -->
  <#if NucleoCond == true >
    <#if McuName?starts_with("STM32C031C6")  >
    <#assign CS_Port = "GPIOC">
    <#assign CS_Pin  = "13">
    <#assign SF_Port = "GPIOB">
    <#assign SF_Pin  = "9">
    <#assign FOC_6STEP_Port = "GPIOB">
    <#assign FOC_6STEP_Pin  = "0">
    ...
    <#elseif McuName?starts_with("STM32C031C6")>
  ...
  <#elseif STM32303E_EVALCond == true>
    ...
    <#assign BoardEnable_Pin  = "2">
    <#assign FOC_6STEP_Port  = "GPIOE">
    <#assign FOC_6STEP_Pin  = "3">	
  ...
  <#elseif STM3240G_EVALCond == true>
      ...
      <#assign BoardEnable_Pin  = "11">
      <#assign FOC_6STEP_Port  = "GPIOH">
      <#assign FOC_6STEP_Pin  = "12">			  
  ...
  <#elseif STM32446E_EVALCond == true>
      ...
      <#assign BoardEnable_Pin  = "8">
      <#assign FOC_6STEP_Port  = "GPIOA">
      <#assign FOC_6STEP_Pin  = "11">
  ...
  <#elseif STM32L476G_EVALCond == true>
      ...
      <#assign FOC_6STEP_Port  = "GPIOF">
      <#assign FOC_6STEP_Pin  = "10">
...
static inline void mc_testenv_init() //cstat !MISRAC2012-Rule-8.2_a !FUNC-unprototyped-all
#ifdef MC_HAL_IS_USED
  {
    ...
    /* Drive type: FOC */
    HAL_GPIO_WritePin( ${FOC_6STEP_Port}, GPIO_PIN_${FOC_6STEP_Pin}, GPIO_PIN_RESET );
    ...
    /* Configuring Drive Type GPIO port and pin */  
