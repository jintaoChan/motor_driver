...
#include "${MC.M1_PWM_DRIVER_PN?lower_case}_driver.h" 
</#if> 
<#if MC.M2_COMPLEX_GATE_DRIVER_INTERFACE != "NONE">
#include "${MC.M2_PWM_DRIVER_PN?lower_case}_driver.h" 
</#if> 
...
<#if (MC.M1_TEMPERATURE_READING == true  && MC.M1_OV_TEMPERATURE_PROT_ENABLING == true) 
  ...
  ||  MC.M1_POTENTIOMETER_ENABLE == true || MC.M2_POTENTIOMETER_ENABLE || MC.M1_CURRENT_MONITOR_READING == true>
...
<#if (MC.M1_SPEED_SENSOR == "STO_PLL") || (MC.M1_SPEED_SENSOR == "STO_CORDIC") || M1_ENCODER 
  || MC.M1_VIEW_ENCODER_FEEDBACK == true || (MC.M1_DBG_OPEN_LOOP_ENABLE && MC.M1_DRIVE_TYPE != "SIX_STEP")>
...
<#if (MC.M2_SPEED_SENSOR == "STO_PLL") || (MC.M2_SPEED_SENSOR == "STO_CORDIC") || M2_ENCODER
   || MC.M2_VIEW_ENCODER_FEEDBACK == true || (MC.M2_DBG_OPEN_LOOP_ENABLE && MC.M2_DRIVE_TYPE != "SIX_STEP")>
extern VirtualSpeedSensor_Handle_t VirtualSpeedSensorM2;
</#if><#-- (MC.M2_SPEED_SENSOR == "STO_PLL") || (MC.M2_SPEED_SENSOR == "STO_CORDIC") || M2_ENCODER
         || MC.M2_VIEW_ENCODER_FEEDBACK == true || (MC.M2_SPEED_SENSOR == "SENSORLESS_ADC") -->
...
<#if MC.M1_COMPLEX_GATE_DRIVER_INTERFACE != "NONE">
extern ${MC.M1_PWM_DRIVER_PN?upper_case}_Handle_t ${MC.M1_PWM_DRIVER_PN?upper_case}_Handle_M1;
extern const ${MC.M1_PWM_DRIVER_PN?upper_case}_defaultParams_t ${MC.M1_PWM_DRIVER_PN?upper_case}_defaultParams_M1;
</#if>
<#if MC.M2_COMPLEX_GATE_DRIVER_INTERFACE != "NONE">
extern ${MC.M2_PWM_DRIVER_PN?upper_case}_Handle_t ${MC.M2_PWM_DRIVER_PN?upper_case}_Handle_M2;
extern const ${MC.M2_PWM_DRIVER_PN?upper_case}_defaultParams_t ${MC.M2_PWM_DRIVER_PN?upper_case}_defaultParams_M2;
</#if>
