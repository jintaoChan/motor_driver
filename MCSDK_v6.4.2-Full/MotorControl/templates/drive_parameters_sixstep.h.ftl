...
/****** Bemf Observer ****/
#define M1_BEMF_SAMPLING_TIME              LL_ADC_SAMPLING_CYCLE(${MC.BEMF_ADC_SAMPLING_TIME})
...
#define M1_MAX_CONSECUTIVE_BEMF_ERRORS     ${MC.M1_MAX_CONSECUTIVE_BEMF_ERRORS} /*!< Max # of consecutive zero crossing event not detected */
...
#define M1_OPENLOOP_DIGITAL_FILTER_SHIFT  (uint8_t)${MC.M1_OPENLOOP_DIGITAL_FILTER_SHIFT} /*!< size of the buffer to store commutation step time */
</#if><#-- MC.M1_DBG_OPEN_LOOP_ENABLE == true-->
...
#define M2_MAX_CONSECUTIVE_BEMF_ERRORS     ${MC.M2_MAX_CONSECUTIVE_BEMF_ERRORS} /*!< Max # of consecutive zero crossing event not detected */
</#if><#-- MC.M2_SPEED_SENSOR == "SENSORLESS_ADC" -->
...
#define LF_TIMER_PSC                       ${MC.LF_TIMER_PSC}U
...
/******************************   On The Fly startUp   **********************/
#define M1_OTF_MAX_BEMF_ERRORS             ${MC.M1_OTF_6S_MAX_BEMF_ERROR} /* max inconsistent detected BEMF values before aborting the on the fly startup */
#define M1_OTF_LS_DETECT_PERC              ${MC.M1_OTF_6S_LS_DETECT_PERC} /* low side MOS duty cycle during on the fly bemf detection phase  */
#define M1_OTF_LS_BRAKE_PERC               ${MC.M1_OTF_6S_LS_BRAKE_PERC} /* low side MOS duty cycle during on the fly braking phase */
#define M1_OTF_BEMF_THRESHOLD_PERC         ${MC.M1_OTF_6S_BEMF_THRESHOLD} /* threshold used to validate bemf transitions */
#define M1_OTF_SPEED_DUTY_CYCLE_RATIO      ${MC.M1_OTF_SPEED_DUTY_CYCLE_RATIO}

</#if><#-- MC.M1_OTF_STARTUP == true-->
/******************************   Initial Position Detection   **********************/
<#if MC.M1_IPD_STARTUP == true> 
#define M1_IPD_PWM_DUTY_CYCLE_PERC         (uint16_t)${MC.M1_IPD_PWM_DUTY_CYCLE_PERC}               /* One pulse mode PWM timer duty cycle. */
#define M1_IPD_PWM_FREQ_HZ                 ${MC.M1_IPD_PWM_FREQ_HZ}                                 /* One pulse mode PWM timer frequency. */
#define M1_IPD_BEMF_RUN_THREHOLD           ${MC.M1_IPD_BEMF_RUN_THREHOLD}                           /* Number of valide BEMF detected during scan phase. */
#define M1_IPD_ADC_BEMF_NUM_TS_CYCLES      ${MC.M1_CUR_MON_ADC_SAMPLING_TIME}                        /* Number of cycles for sampling time. */
#define M1_IPD_ADC_BEMF_NUM_TS_TIME        LL_ADC_SAMPLING_CYCLE(${MC.M1_CUR_MON_ADC_SAMPLING_TIME}) /* Corresponding Value to set up into ADC. */
</#if><#-- MC.M1_IPD_STARTUP == true-->
...
<#if MC.M1_CURRENT_MONITOR_READING >
/******************************   Current sensing Motor 1   **********************/
#define  M1_CUR_MON_ADC_SAMPLING_TIME      LL_ADC_SAMPLING_CYCLE(${MC.M1_CUR_MON_ADC_SAMPLING_TIME})
#define  M1_CUR_MON_ADC_SAMPLING_TIME_NS   ${MC.M1_CUR_MON_ADC_SAMPLING_TIME_NS}
</#if>
