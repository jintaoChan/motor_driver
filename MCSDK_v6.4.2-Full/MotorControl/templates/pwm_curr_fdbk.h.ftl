...
<#if MC.M1_DTCOMP_SUPPORT == true || MC.M2_DTCOMP_SUPPORT == true>
...
<#if ((MC.M1_CURRENT_SENSING_TOPO == 'SINGLE_SHUNT_PHASE_SHIFT') || (MC.M1_CURRENT_SENSING_TOPO == 'SINGLE_SHUNT_ACTIVE_WIN') 
  ...
  bool ChargeBootCap;                                  /*!< ChargeBootCap is used */
  uint32_t ChargeBootCapDutyCycles;                    /*!< ChargeBootCapDutyCycles to be used */
</#if>   
};
