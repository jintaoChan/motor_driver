...
<#elseif CondFamily_STM32U5>
  * @ingroup STM32U5xx_IRQ_Handlers
</#if><#-- CondFamily_STM32C0 CondFamily_STM32F0 CondFamily_STM32F4 CondFamily_STM32F7 CondFamily_STM32F3 CondFamily_STM32G0 CondFamily_STM32G4 CondFamily_STM32H7 CondFamily_STM32L4 CondFamily_STM32U5-->
  */ 
...
</#if><#-- CondFamily_STM32C0 CondFamily_STM32F0 CondFamily_STM32F4 CondFamily_STM32F7 CondFamily_STM32F3 CondFamily_STM32G0 CondFamily_STM32G4 CondFamily_STM32H5 CondFamily_STM32H7 CondFamily_STM32L4 CondFamily_STM32U5-->
<#if MC.MCP_EN>
...
<#elseif CondFamily_STM32U5>
/** @addtogroup STM32LU5xx_IRQ_Handlers STM32U5xx IRQ Handlers
...
void SPD_ENC_TIM_M1_IRQHandler(void);
  ...
  <#if CondFamily_STM32F4 || CondFamily_STM32F3 || CondFamily_STM32G4 || CondFamily_STM32H5>
    <#if MC.DRIVE_NUMBER != "1">
      <#if (M2_ENCODER == true)>
void SPD_ENC_TIM_M2_IRQHandler(void);
      </#if><#-- (M2_ENCODER == true) -->
    </#if><#-- MC.DRIVE_NUMBER > 1 -->
  </#if><#-- CondFamily_STM32F4 || CondFamily_STM32F3 || CondFamily_STM32G4 || CondFamily_STM32H5 -->
</#if><#-- CondFamily_STM32C0 CondFamily_STM32F0 CondFamily_STM32F4 CondFamily_STM32F7 CondFamily_STM32F3 CondFamily_STM32G0 CondFamily_STM32G4 CondFamily_STM32H5 CondFamily_STM32H7 CondFamily_STM32L4 -->
...
void ${MC.MCP_IRQ_HANDLER_UART_A}(void)
{
  ...
  <#if CondFamily_STM32C0 || CondFamily_STM32F4 || CondFamily_STM32F7 || CondFamily_STM32F3 || CondFamily_STM32G0 || CondFamily_STM32G4 || CondFamily_STM32H5 || CondFamily_STM32L4 || CondFamily_STM32U5>
  uint32_t oreFlag;
  uint32_t feFlag;
  uint32_t neFlag;
  uint32_t errorMask;
  ...
  { /* Stopping the debugger will generate an OverRun error*/
    <#if CondFamily_STM32C0  || CondFamily_STM32G0 || CondFamily_STM32G4 || CondFamily_STM32H5 || CondFamily_STM32L4 || CondFamily_STM32U5>
  ...
  <#if CondFamily_STM32C0 || CondFamily_STM32F4 || CondFamily_STM32F7 || CondFamily_STM32F3 || CondFamily_STM32G0 || CondFamily_STM32G4 || CondFamily_STM32H5 || CondFamily_STM32H7 || CondFamily_STM32L4 || CondFamily_STM32U5>
...
static uint8_t SystickDividerCounter = SYSTICK_DIVIDER;
  ...
  <#if CondFamily_STM32F0 || CondFamily_STM32F4 || CondFamily_STM32F7 || CondFamily_STM32F3 || CondFamily_STM32G0 || CondFamily_STM32G4 || CondFamily_STM32H5 || CondFamily_STM32L4 || CondFamily_STM32U5>
...
<#-- GUI, this section is present only if start/stop button and/or Position Control with Z channel is enabled -->
  ...
  <#if MC.START_STOP_BTN == true>
    ...
    <#if CondFamily_STM32C0 || CondFamily_STM32G0 || CondFamily_STM32U5>
      <#if _last_word(MC.START_STOP_GPIO_PIN)?number < 32 >
      <#assign Template_StartStop = '/* USER CODE BEGIN START_STOP_BTN */
  if ((0U != LL_EXTI_ReadRisingFlag_0_31(LL_EXTI_LINE_${_last_word(MC.START_STOP_GPIO_PIN)})) ||
      (0U != LL_EXTI_ReadFallingFlag_0_31(LL_EXTI_LINE_${_last_word(MC.START_STOP_GPIO_PIN)}))) 
  {
    ...
    UI_HandleStartStopButton_cb();
      ...
      <#else>
      <#assign Template_StartStop = '/* USER CODE BEGIN START_STOP_BTN */
  if ((0U != LL_EXTI_ReadRisingFlag_32_63(LL_EXTI_LINE_${_last_word(MC.START_STOP_GPIO_PIN)})) ||
      (0U != LL_EXTI_ReadFallingFlag_32_63(LL_EXTI_LINE_${_last_word(MC.START_STOP_GPIO_PIN)})))
  {
    ...
    <#elseif CondFamily_STM32H5>
      <#if _last_word(MC.START_STOP_GPIO_PIN)?number < 32 >
        <#assign Template_StartStop = '/* USER CODE BEGIN START_STOP_BTN */
  if (0U != LL_EXTI_ReadFallingFlag_0_31(LL_EXTI_LINE_${_last_word(MC.START_STOP_GPIO_PIN)}) ) 
  {                                                                                
    LL_EXTI_ClearFallingFlag_0_31 (LL_EXTI_LINE_${_last_word(MC.START_STOP_GPIO_PIN)});  
  ...
  <#if MC.M1_SPEED_SENSOR == "QUAD_ENCODER_Z">
    ...
    <#if CondFamily_STM32C0 || CondFamily_STM32G0 || CondFamily_STM32H5 || CondFamily_STM32U5>
      <#if _last_word(MC.M1_ENC_Z_GPIO_PIN)?number < 32 >
      <#assign Template_Encoder_Z_M1 = '/* USER CODE BEGIN ENCODER Z INDEX M1 */
  if ((0U != LL_EXTI_ReadRisingFlag_0_31(LL_EXTI_LINE_${_last_word(MC.M1_ENC_Z_GPIO_PIN)})) ||
      (0U != LL_EXTI_ReadFallingFlag_0_31(LL_EXTI_LINE_${_last_word(MC.M1_ENC_Z_GPIO_PIN)})))
  {
  ...
  if ((0U != LL_EXTI_ReadRisingFlag_32_63(LL_EXTI_LINE_${_last_word(MC.M1_ENC_Z_GPIO_PIN)})) ||
      (0U != LL_EXTI_ReadFallingFlag_32_63(LL_EXTI_LINE_${_last_word(MC.M1_ENC_Z_GPIO_PIN)})))
  {
    ...
    <#elseif CondFamily_STM32F0 || CondFamily_STM32F4 || CondFamily_STM32F7 || CondFamily_STM32F3 || CondFamily_STM32G4 || CondFamily_STM32L4>
      <#if _last_word(MC.M1_ENC_Z_GPIO_PIN)?number < 32 >
        <#assign Template_Encoder_Z_M1 = '/* USER CODE BEGIN ENCODER Z INDEX M1 */
  if (0U != LL_EXTI_ReadFlag_0_31(LL_EXTI_LINE_${_last_word(MC.M1_ENC_Z_GPIO_PIN)}))
  {
  ...
  <#assign Template_Encoder_Z_M1 = '/* USER CODE BEGIN ENCODER Z INDEX M1 */
  if (0U != LL_EXTI_ReadFlag_32_63(LL_EXTI_LINE_${_last_word(MC.M1_ENC_Z_GPIO_PIN)})) 
  {
  ...
  <#if CondFamily_STM32F4 || CondFamily_STM32F7 || CondFamily_STM32F3 || CondFamily_STM32G4>
  ...
  if (0U != LL_EXTI_ReadFlag_0_31(LL_EXTI_LINE_${_last_word(MC.M2_ENC_Z_GPIO_PIN)}))
  {
    ...
    TC_EncoderReset(&PosCtrlM2);
      ...
      <#else><#-- _last_word(MC.M2_ENC_Z_GPIO_PIN)?number >= 32 -->
        <#assign Template_Encoder_Z_M2 = '/* USER CODE BEGIN ENCODER Z INDEX M2 */
  if (0U != LL_EXTI_ReadFlag_32_63(LL_EXTI_LINE_${_last_word(MC.M2_ENC_Z_GPIO_PIN)}))
  {
