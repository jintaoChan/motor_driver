...
<#if MC.M1_COMPLEX_GATE_DRIVER_INTERFACE != "NONE">
    ...
    /*******************************************************
       ${MC.M1_PWM_DRIVER_PN?upper_case} initialization  
    ********************************************************/
    ${MC.M1_PWM_DRIVER_PN?upper_case}_Init(&${MC.M1_PWM_DRIVER_PN?upper_case}_Handle_M1, &${MC.M1_PWM_DRIVER_PN?upper_case}_defaultParams_M1);
</#if> <#-- MC.M1_COMPLEX_GATE_DRIVER_INTERFACE != "NONE" -->
<#if MC.DRIVE_NUMBER != "1">
  <#if MC.M2_COMPLEX_GATE_DRIVER_INTERFACE != "NONE">

    /*******************************************************
       ${MC.M2_PWM_DRIVER_PN?upper_case} initialization  
    ********************************************************/
    ${MC.M2_PWM_DRIVER_PN?upper_case}_Init(&${MC.M2_PWM_DRIVER_PN?upper_case}_Handle_M2, &${MC.M2_PWM_DRIVER_PN?upper_case}_defaultParams_M2);
  </#if> <#-- MC.M2_COMPLEX_GATE_DRIVER_INTERFACE != "NONE" -->
</#if> <#-- MC.DRIVE_NUMBER != "1" -->
...
<#if MC.M1_COMPLEX_GATE_DRIVER_INTERFACE != "NONE">
    ${MC.M1_PWM_DRIVER_PN?upper_case}_MF_Management(&${MC.M1_PWM_DRIVER_PN?upper_case}_Handle_M1);
</#if>
...
<#if MC.M2_COMPLEX_GATE_DRIVER_INTERFACE != "NONE">
    ${MC.M2_PWM_DRIVER_PN?upper_case}_MF_Management(&${MC.M2_PWM_DRIVER_PN?upper_case}_Handle_M2);
</#if>
...
<#if SIX_STEP && MC.M1_CURRENT_MONITOR_READING == true && MC.M1_SPEED_SENSOR == "HALL_SENSOR">
...
</#if><#-- SIX_STEP && MC.M1_CURRENT_MONITOR_READING == true -->
<#if MC.PFC_ENABLED == true>
...
<#else><#-- (MC.M1_ON_OVER_VOLTAGE == "TURN_OFF_PWM") or not defined -->
...
<#if (MC.DRIVE_NUMBER != "1")>
  ...
  <#else> <#-- (MC.M2_ON_OVER_VOLTAGE == "TURN_OFF_PWM") or not defined -->
...
__weak void TSK_SafetyTask_PWMOFF(uint8_t bMotor)
{
  ...
  uint8_t lbmotor = M1;
  <#if MC.M1_BUS_VOLTAGE_READING == true || MC.M2_BUS_VOLTAGE_READING == true || (MC.M1_TEMPERATURE_READING == true  && MC.M1_OV_TEMPERATURE_PROT_ENABLING == true) || (MC.M2_TEMPERATURE_READING == true  && MC.M2_OV_TEMPERATURE_PROT_ENABLING == true)>
    <#if MC.DRIVE_NUMBER != "1">
...
<#if (MC.M2_TEMPERATURE_READING == true  && MC.M2_OV_TEMPERATURE_PROT_ENABLING == true)>
  if (M2 == bMotor)
  {
    uint16_t rawValueM2 = RCM_GetRegularConv(&TempRegConv_M2);
...
<#if MC.M1_COMPLEX_GATE_DRIVER_INTERFACE != "NONE">
    if (M1 == bMotor)
    {
      ${MC.M1_PWM_DRIVER_PN?upper_case}_FaultManagement(&${MC.M1_PWM_DRIVER_PN?upper_case}_Handle_M1);
    }
    else
    {
      /* nothing to do */
...
<#if MC.DRIVE_NUMBER != "1">
  <#if MC.M2_COMPLEX_GATE_DRIVER_INTERFACE != "NONE">
    if (M2 == bMotor)
    {
      ${MC.M2_PWM_DRIVER_PN?upper_case}_FaultManagement(&${MC.M2_PWM_DRIVER_PN?upper_case}_Handle_M2);
    }
    else
    {
      /* nothing to do */
