...
#ifdef NOT_IMPLEMENTED /* ETRFault is always enabled in the current implementation */
...
#ifdef NOT_IMPLEMENTED /* This is only needed when ETRFault is disabled.
...
typedef struct
{
  ...
  PQD_MotorPowMeas_Handle_t * pMPW1;    /**< pointer on the component measuring the power consumed by motor 1 */
  PQD_MotorPowMeas_Handle_t * pMPW2;    /**< pointer on the component measuring the power consumed by motor 2 */
