...
<#if (MC.M1_SPEED_SENSOR != "HSO") && (MC.M2_SPEED_SENSOR != "HSO")>
...
<#if FOC>
  ...
  <#if (AUX_SPEED_FDBK_M1 || AUX_SPEED_FDBK_M2)>
...
<#if DWT_CYCCNT_SUPPORTED><#--              pPerfMeasure definition should be placed at struct end due to -->
  <#if MC.DBG_MCU_LOAD_MEASURE == true><#-- FW Motor Profiler library MCI.State/.DirectCommand access     -->
