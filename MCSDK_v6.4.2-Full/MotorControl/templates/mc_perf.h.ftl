...
<#if MC.DRIVE_NUMBER != "1">
  MEASURE_TSK_HighFrequencyTaskM2,
  MEASURE_TSK_MediumFrequencyTaskM2
</#if><#-- MC.DRIVE_NUMBER > 1 -->
...
<#if SIX_STEP>
  <#if MC.M1_SPEED_SENSOR == "SENSORLESS_ADC">
#define  MC_PERF_NB_TRACES  ${MC.DRIVE_NUMBER?number * 3}U
  <#else><#-- MC.M1_SPEED_SENSOR != "SENSORLESS_ADC" -->
#define  MC_PERF_NB_TRACES  ${MC.DRIVE_NUMBER?number * 2}U
  </#if><#-- MC.M1_SPEED_SENSOR == "SENSORLESS_ADC" -->
<#else><#-- SIX_STEP -->
#define  MC_PERF_NB_TRACES  ${MC.DRIVE_NUMBER?number * 2}U
</#if><#-- SIX_STEP -->
