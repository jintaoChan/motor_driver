...
<#if .vars.MC["M" + MOTOR_NUM?c + "_DRIVE_TYPE"] == "SIX_STEP">
  ...
  <#if .vars.MC["M" + MOTOR_NUM?c + "_DBG_OPEN_LOOP_ENABLE"] == true>
    ...
    <#if .vars.MC["M" + MOTOR_NUM?c + "_SPEED_SENSOR"] == "SENSORLESS_ADC">
  ...
  <#if .vars.MC["M" + MOTOR_NUM?c + "_IPD_STARTUP"] == true>
         case MC_REG_IPD_ENABLE:
        {
          uint8_t regdata8 = *data;
          IPD_6S_SetIPDStartUpFlag(&IPD_M1, regdata8);
          break;
        }
        
        case MC_REG_IPD_DEBUG:
        {
          uint8_t regdata8 = *data;
          IPD_6S_SetIPDDebugFlag(&IPD_M1, regdata8);
          break;
        }
...
<#if .vars.MC["M" + MOTOR_NUM?c + "_DRIVE_TYPE"] == "SIX_STEP">
  ...
  <#if .vars.MC["M" + MOTOR_NUM?c + "_IPD_STARTUP"] == true>
        case MC_REG_IPD_VSTR:
        {
          uint8_t regdata8 = *data;
          IPD_6S_SetNbBemfSampleToRun(&IPD_M1, regdata8);
          break;
        }

        case MC_REG_IPD_VSTPTR:
        {
          uint8_t regdata8 = *data;
          IPD_6S_SetNbStepToRun(&IPD_M1, regdata8);
          break;
        }
  </#if><#-- MC.M1_IPD_STARTUP == true -->
...
<#if MEMORY_FOOTPRINT_REG>
  ...
  <#if .vars["M" + MOTOR_NUM?c + "_IS_SENSORLESS"] || (.vars.MC["M" + MOTOR_NUM?c + "_SPEED_SENSOR"] == "SENSORLESS_ADC")|| (.vars.MC["M" + MOTOR_NUM?c + "_SPEED_SENSOR"] == "SENSORLESS_COMP")>
    ...
    <#if SIX_STEP >
              (void)RUC_6S_SetPhase(&RevUpControlM${MOTOR_NUM}, i, &revUpPhase);
    </#if><#-- DRIVE_TYPE == "SIX_STEP" -->	
              }
            }
            break;
...
<#if .vars["M" + MOTOR_NUM?c + "_IS_SENSORLESS"] || (.vars.MC["M" + MOTOR_NUM?c + "_SPEED_SENSOR"] == "SENSORLESS_ADC")>
    ...
    <#if SIX_STEP>
              *data = (uint8_t)RUC_6S_GetNumberOfPhases(&RevUpControlM${MOTOR_NUM});
    </#if><#-- DRIVE_TYPE == "SIX_STEP" -->  
              break;
            }
</#if><#-- IS_SENSORLESS -->
...
<#if .vars.MC["M" + MOTOR_NUM?c + "_DRIVE_TYPE"] == "SIX_STEP">
            ...
            case MC_REG_QUASI_SYNCH:  
            {
              *data = (uint8_t)PWMC_GetQuasiSynchState(&PWM_Handle_M${MOTOR_NUM});			
              break;
            }
  ...
  <#if .vars.MC["M" + MOTOR_NUM?c + "_IPD_STARTUP"] == true>
            case MC_REG_IPD_ENABLE:
            {
              *data = (uint8_t)IPD_6S_GetIPDStartUpFlag(&IPD_M1);
              break;
            }

            case MC_REG_IPD_DEBUG:
            {
              *data = (uint8_t)IPD_6S_GetIPDDebugFlag(&IPD_M1);
              break;
            }
  </#if><#-- MC.M1_IPD_STARTUP == true -->
</#if><#-- DRIVE_TYPE == "SIX_STEP" -->
...
<#if .vars.MC["M" + MOTOR_NUM?c + "_DRIVE_TYPE"] == "SIX_STEP">
  ...
  <#if .vars.MC["M" + MOTOR_NUM?c + "_IPD_STARTUP"] == true>
            case MC_REG_IPD_VSTR:
            {
              *regdataU16 = IPD_6S_GetNbBemfSampleToRun(&IPD_M1);
              break;
            }

            case MC_REG_IPD_VSTPTR:
            {
              *regdataU16 = IPD_6S_GetValidNbStepToRun(&IPD_M1);
              break;
            }
  </#if><#-- MC.M1_IPD_STARTUP == true --> 
</#if><#-- DRIVE_TYPE == "SIX_STEP" -->
...
<#if MEMORY_FOOTPRINT_REG>
  ...
  <#if .vars["M" + MOTOR_NUM?c + "_IS_SENSORLESS"] || (.vars.MC["M" + MOTOR_NUM?c + "_SPEED_SENSOR"] == "SENSORLESS_ADC")|| (.vars.MC["M" + MOTOR_NUM?c + "_SPEED_SENSOR"] == "SENSORLESS_COMP")>
    ...
    <#if SIX_STEP>
                (void)RUC_6S_GetPhase( &RevUpControlM${MOTOR_NUM} ,i, &revUpPhase);
    </#if><#-- DRIVE_TYPE == "SIX_STEP" -->  
    <#if UNALIGNMENT_SUPPORTED>
  ...
  <#if .vars.MC["M"+ MOTOR_NUM?c + "_POSITION_CTRL_ENABLING"]>
          case MC_REG_POSITION_RAMP:
          {
            ...
            *rawSize = 8;
            Position = TC_GetTargetPosition(&PosCtrlM${MOTOR_NUM});
            Duration = TC_GetMoveDuration(&PosCtrlM${MOTOR_NUM});   /* Does this duration make sense ? */
