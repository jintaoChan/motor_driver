...
<#if MC.M1_SPEED_SENSOR == "HSO" || MC.M1_SPEED_SENSOR == "ZEST">
    (void)HF_GetPtrReg((MC_REG_I_ALPHA + 0x1U), (void *)&pHandle->ptrDataCh[DAC_CH1]); //cstat !MISRAC2012-Rule-11.5
<#else>
    (void)HF_GetPtrReg((MC_REG_I_ALPHA_MEAS + 0x1U), (void *)&pHandle->ptrDataCh[DAC_CH1]); //cstat !MISRAC2012-Rule-11.5
</#if>    
...
#endif
    /* CH2 configuration  */ 
    /* By default send Ibeta motor 1 */
    (void)HF_GetPtrReg((MC_REG_I_BETA_MEAS + 0x1U), (void *)&pHandle->ptrDataCh[DAC_CH2]); //cstat !MISRAC2012-Rule-11.5
...
<#elseif MC.DEBUG_DAC_CH2_EN == true >
  ...
  else
  {
    ...
    /* By default send Ibeta motor 1 */
<#if MC.M1_SPEED_SENSOR == "HSO" || MC.M1_SPEED_SENSOR == "ZEST">
    (void)HF_GetPtrReg((MC_REG_I_BETA + 0x1U), (void *)&pHandle->ptrDataCh[DAC_CH2]); //cstat !MISRAC2012-Rule-11.5
<#else>    
    (void)HF_GetPtrReg((MC_REG_I_BETA_MEAS + 0x1U), (void *)&pHandle->ptrDataCh[DAC_CH2]); //cstat !MISRAC2012-Rule-11.5
</#if> 
