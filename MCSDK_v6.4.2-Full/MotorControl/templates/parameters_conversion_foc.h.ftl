...
#include "parameters_conversion_u5xx.h"
</#if><#-- CondFamily_STM32F0 -->
...
#define MAX_VOLTAGE2                        (int16_t)((ADC_REFERENCE_VOLTAGE / SQRT_3) / VBUS_PARTITIONING_FACTOR2)
  <#else><#-- MC.M2_BUS_VOLTAGE_READING -->
...
#define M1_CHARGE_BOOT_CAP_TICKS          (((uint16_t)SYS_TICK_FREQUENCY * 1U) / 1000U)
  <#else><#-- !M1_OTF_STARTUP -->
...
#define M2_CHARGE_BOOT_CAP_TICKS         (((uint16_t)SYS_TICK_FREQUENCY * 1U) / 1000U)
  <#else><#-- !M2_OTF_STARTUP -->
...
#define SPD_HALL_TIM_M1_IRQHandler               ${TimerHandler(_last_word(MC.M1_HALL_TIMER_SELECTION))}
</#if><#-- (MC.M1_SPEED_SENSOR == "HALL_SENSOR") || (MC.M1_AUXILIARY_SPEED_SENSOR == "HALL_SENSOR") -->
...
#define SPD_HALL_TIM_M2_IRQHandler               ${TimerHandler(_last_word(MC.M2_HALL_TIMER_SELECTION))}
</#if><#-- (MC.M2_SPEED_SENSOR == "HALL_SENSOR") || (MC.M2_AUXILIARY_SPEED_SENSOR == "HALL_SENSOR") -->
...
#define SPD_ENC_TIM_M1_IRQHandler               ${TimerHandler(_last_word(MC.M1_ENC_TIMER_SELECTION))}
</#if><#-- M1_ENCODER -->
...
#define SPD_ENC_TIM_M2_IRQHandler               ${TimerHandler(_last_word(MC.M2_ENC_TIMER_SELECTION))}
</#if><#-- M2_ENCODER -->
