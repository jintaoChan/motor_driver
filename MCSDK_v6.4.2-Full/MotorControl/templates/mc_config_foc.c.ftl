...
SpeednTorqCtrl_Handle_t SpeednTorqCtrlM1 =
{
  ...
  .AUXSPD = (SpeednPosFdbk_Handle_t *) &${GetSpeedSensorInstance('M1',true)},
  </#if>
};
...
<#if CHARGE_BOOT_CAP_ENABLING == true>  
    .ChargeBootCap              = true,
    .ChargeBootCapDutyCycles    = M1_CHARGE_BOOT_CAP_DUTY_CYCLES,
  <#else><#-- CHARGE_BOOT_CAP_ENABLING == false -->
    .ChargeBootCap              = false,
    .ChargeBootCapDutyCycles    = 0,
</#if><#-- CHARGE_BOOT_CAP_ENABLING == true -->
  },
...
<#if CHARGE_BOOT_CAP_ENABLING2 == true>
    .ChargeBootCap              = true,
    .ChargeBootCapDutyCycles    = M2_CHARGE_BOOT_CAP_DUTY_CYCLES,
...
PWMC_R3_1_Handle_t PWM_Handle_M1 =
{
  ...
  <#if CondFamily_STM32F3 || CondFamily_STM32H5 || CondFamily_STM32G4 || CondFamily_STM32U5>
  ...
  </#if><#-- CondFamily_STM32F0 || CondFamily_STM32F7 || CondFamily_STM32G0 || CondFamily_STM32H5 || CondFamily_STM32G4 || CondFamily_STM32C0 || CondFamily_STM32U5-->
    .LowSideOutputs    = (LowSideOutputsFunction_t)LOW_SIDE_SIGNALS_ENABLING,
  <#if MC.M1_LOW_SIDE_SIGNALS_ENABLING == "ES_GPIO">
    <#if MC.M1_SHARED_SIGNAL_ENABLE == false>
    .pwm_en_u_port     = M1_PWM_EN_U_GPIO_Port,
...
PWMC_R3_1_Handle_t PWM_Handle_M2 =
{
  ...
  <#else><#-- (CondFamily_STM32F3 || CondFamily_STM32H5 || CondFamily_STM32G4) -->
    ...
    .pFctTurnOnLowSides         = &R3_1_TurnOnLowSides,
    .pFctOCPSetReferenceVoltage = MC_NULL,
  <#if CondFamily_STM32F7 || CondFamily_STM32G4 || CondFamily_STM32U5>
    .pFctRLDetectionModeEnable  = MC_NULL,
    .pFctRLDetectionModeDisable = MC_NULL,
    .pFctRLDetectionModeSetDuty = MC_NULL,
    .pFctRLTurnOnLowSidesAndStart = MC_NULL,
...
SpeednTorqCtrl_Handle_t SpeednTorqCtrlM2 =
{
  ...
  .AUXSPD = (SpeednPosFdbk_Handle_t *) &${GetSpeedSensorInstance('M2',true)},
  </#if>  
};
...
FF_Handle_t *pFF[NBR_OF_MOTORS]                 = {&FF_M1};
  ...
  <#if MC.M1_ON_OVER_VOLTAGE == "TURN_ON_R_BRAKE"> 
DOUT_handle_t *pR_Brake[NBR_OF_MOTORS] = {&R_BrakeParamsM1}; 
  </#if> <#-- MC.M1_ON_OVER_VOLTAGE == "TURN_ON_R_BRAKE" -->
</#if><#-- MC.DRIVE_NUMBER > 1 -->
