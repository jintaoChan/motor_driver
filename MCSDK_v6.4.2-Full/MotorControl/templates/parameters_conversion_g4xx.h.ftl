...
#define HALL_TIM_CLK                     ${APB1Tim_CLKFreq}uL
...
#define HALL_TIM_CLK2                    ${APB1Tim_CLKFreq}uL
 </#if>
...
#define BEMF_ADC3_READING_IRQHandler     ADC3_IRQHandler
    ...
    <#if MC.PHASE_U_BEMF_ADC == "ADC4" || MC.PHASE_V_BEMF_ADC == "ADC4" || MC.PHASE_W_BEMF_ADC == "ADC4">
...
#define CURRENT_SENSE_IRQHandler   ADC1_2_IRQHandler
    </#if> <#-- ADC1 || ADC2-->
    <#if MC.M1_CURRENT_MONITOR_READING == true && MC.M1_CUR_MON_ADC == "ADC3">
#define CURRENT_SENSE_IRQHandler     ADC3_IRQHandler
    </#if> <#-- ADC3-->
    <#if MC.M1_CURRENT_MONITOR_READING == true && MC.M1_CUR_MON_ADC == "ADC4">
#define CURRENT_SENSE_IRQHandler     ADC4_IRQHandler
    </#if> <#-- ADC4-->
  </#if>
</#if>
<#if FOC>
...
#define ADC_SAR_CYCLES                   12.5 <#-- work around 30 for one shunt phase shift todo -->
